...
- Treat wallpapers as part of the system identity. Keep them dark, OLED-friendly, and consistent with Biscuit. Use exactly two model calls per scene: one short Seedream Pro prompt creates the complete native `2560x1440` core; one Seedream Lite prompt outpaints only the natural left-side environment to a native `5120x1440` master while preserving the accepted core. If Pro rejects a scene, retry the unchanged core prompt with Lite at `2560x1440`. Derive 21:9 UWQHD `3440x1440` from the right side and retain the accepted core for 16:9 WQHD `2560x1440`. Never stretch an axis or add padding. Do not describe percentage-based layout zones: models tend to turn those instructions into a visible diptych seam.
- Make 16:9, 21:9 and 32:9 three windows onto one continuous world. Keep every character, face, narrative action, important prop and strongest light entirely on the right. Foreground, midground and background preserve perspective and material scale as they extend left, but become progressively sparser and darker through weaker GI, deeper occlusion and natural light falloff until true `#000000` dominates the far-left edge. Natural dark gradients in light, mist, sky, water and atmospheric depth are desirable and must remain smooth; never use an artificial gradient mask, abrupt black veil, blur, vertical tonal boundary, repeated tile, pasted rectangle or giant occluding object to hide missing scenery.
- Do not put DevSecOps mechanisms, product logos, ports, pipelines, dashboards, fake code, technology names, unexplained numbers or decorative IT text into wallpapers. Visual quality and an authentic universe always outrank a technical metaphor. Text is absent unless it is an unavoidable canonical environmental detail already natural to the depicted world.
- Keep every wallpaper inside one universe. Do not add crossovers, easter eggs, technical metaphors, product props or unrelated decorative references: they compete with beauty and frequently look pasted into the scene.
- Give each wallpaper an original narrative native to its game or anime universe. Document its filename, mood, inspiration boundary and scene role in `wallpapers/CONCEPTS.md`; record only genuinely visible details in `wallpapers/INVENTORY.md` after generation.
- Require every declared universe to be recognizable within seconds through its original character design, default wardrobe language, camera grammar, rendering, environment, gameplay systems and emotional tone. Preserve six distinct visual languages with three scenes each: Frieren anime (01–03), Chainsaw Man anime (04–06), Solo Leveling anime (07–09), authentic Valheim low-poly painterly rendering (10–12), authentic V Rising stylized-isometric rendering (13–15), and authentic Palworld 3D anime-game rendering (16–18). Never homogenize them into one generic anime, photoreal movie or concept-art style.
- Depict Frieren, Fern, Stark, Makima, Denji, Power, Sung Jinwoo and Igris as the actual canonical characters with recognizable default wardrobe language and equipment, not lookalikes or provocative redesigns. Palworld scenes need a real Palbox where relevant, recognizable canonical Pals performing plausible work specializations and an overbuilt survival base. V Rising scenes need isometric domain construction and a vampire whose completely closed opaque helmet hides the whole face, eyes and skin. Valheim scenes need low-poly painterly geometry, survival craft, weather and procedural landscape rather than a realistic Viking film.
...
- For OLED, target roughly 35–50% genuinely emitted-off `#000000` pixels through organic negative space, arch cavities, foliage gaps, deep water, unlit rooms and material occlusion, with most of that black weighted toward the left side. Never satisfy this with one empty sky, pasted rectangle, artificial gradient mask or crushed background plane. Lite should make left-side scenery fade naturally into predominantly `#000000` through sparser geometry, weaker GI, deeper occlusion and smooth band-free tonal gradients. Exploit OLED color and contrast rather than muting them: preserve rich color separation, strong local contrast, physically coherent global illumination, soft ambient occlusion, contact shadows, volumetric depth and material-aware bounced light toward the right-side focal action. Keep average picture level low and avoid only broad glare, clipped highlights, aggressive bloom and large white or neon surfaces.
