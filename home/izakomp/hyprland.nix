  ...
  wayland.windowManager.hyprland = {
    ...
    extraLuaFiles."config" = builtins.replaceStrings
      ...
      [
        ...
        (toString uiScale)
        (lib.concatStrings [
          # Voxtype's daemon owns transcription; Hyprland only toggles capture,
          # avoiding privileged evdev hotkeys and working identically per host.
          ''
            bind_exec(mod .. " + V", "voxtype record toggle")
          ''
